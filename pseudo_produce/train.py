...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', default=88, type=int, help='train batch size')
    parser.add_argument('--num_epochs', default=50, type=int, help='train epoch number')  # 50轮就差不多了
