...
class Model(nn.Module):
    def __init__(self, backbone_type, gd_config, feature_dim, num_classes):
        ...
        backbone = timm.create_model('swin_base_patch4_window12_384_in22k', pretrained=False,global_pool="",num_classes=0,features_only=False)
        self.features = []
    ...
    def forward(self, x):
        ...
        #print(shared.shape)
        shared = shared.reshape(shared.shape[0],1024,12,12)
        global_descriptors = []
