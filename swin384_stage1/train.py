...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_epochs', default=60, type=int, help='train epoch number')  # 50轮就差不多了
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        if epoch in [52, 56, 28]:
            torch.save(model.state_dict(), 'results/{}_model{}.pth'.format(save_name_pre,epoch))
